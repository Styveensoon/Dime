...
export default function TestPHQ9() {
    ...
    const questions = [
        { id: 1, text: "Sentirse nervioso(a), ansioso(a) o con los nervios de punta" },
        ...
        { id: 5, text: "Estar tan inquieto(a) que es difícil permanecer sentado(a)" },
        { id: 6, text: "Molestarse o irritarse fácilmente" },
        { id: 7, text: "Sentir miedo como si algo terrible pudiera suceder" },
    ];
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 60 }}>
            <ThemedView style={styles.titleContainer}>
                <ThemedText type="title" style={{ color: IMSS_GREEN }}>Test PHQ-9</ThemedText>
            </ThemedView>
