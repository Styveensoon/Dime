...
export default function TestGAD7() {
    ...
    const questions = [
        ...
        { id: 6, text: "Se siente mal consigo mismo(a) — o siente que es un fracaso" },
        { id: 7, text: "Dificultad para concentrarse en las cosas" },
        { id: 8, text: "Se mueve o habla tan lentamente que los demás lo notan" },
        { id: 9, text: "Pensamientos de que estaría mejor muerto(a)" },
    ];
    ...
    return (
        <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 60 }}>
            <ThemedView style={styles.titleContainer}>
                <ThemedText type="title" style={{ fontFamily: Fonts.rounded, color: IMSS_GREEN }}>
                    Test GAD-7
                </ThemedText>
                <ThemedText style={styles.subtitle}>
                    Evaluación inicial de Ansiedad.
                </ThemedText>
            </ThemedView>
